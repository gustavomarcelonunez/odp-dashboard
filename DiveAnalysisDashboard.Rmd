...
renderDataTable({
  parsedSpecieId <- sub("^.*Q([0-9]+).*$", "\\1", selectedSpeciesID())
 ...
 # ncbi_id <-n[n$Database == 'NCBI taxonomy ID',] 
...
reactive({
  print(species)
  print(selectionSpecie())
  print(selectedSpeciesID())
})
```
More
=====================================
